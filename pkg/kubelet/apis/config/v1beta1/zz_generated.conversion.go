...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1beta1.OpenTelemetryConfig)(nil), (*config.OpenTelemetryConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_OpenTelemetryConfig_To_config_OpenTelemetryConfig(a.(*v1beta1.OpenTelemetryConfig), b.(*config.OpenTelemetryConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.OpenTelemetryConfig)(nil), (*v1beta1.OpenTelemetryConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_OpenTelemetryConfig_To_v1beta1_OpenTelemetryConfig(a.(*config.OpenTelemetryConfig), b.(*v1beta1.OpenTelemetryConfig), scope)
	}); err != nil {
		return err
	}
...
// Convert_v1beta1_OpenTelemetryConfig_To_config_OpenTelemetryConfig is an autogenerated conversion function.
func Convert_v1beta1_OpenTelemetryConfig_To_config_OpenTelemetryConfig(in *v1beta1.OpenTelemetryConfig, out *config.OpenTelemetryConfig, s conversion.Scope) error {
	return autoConvert_v1beta1_OpenTelemetryConfig_To_config_OpenTelemetryConfig(in, out, s)
}
...
// Convert_config_OpenTelemetryConfig_To_v1beta1_OpenTelemetryConfig is an autogenerated conversion function.
func Convert_config_OpenTelemetryConfig_To_v1beta1_OpenTelemetryConfig(in *config.OpenTelemetryConfig, out *v1beta1.OpenTelemetryConfig, s conversion.Scope) error {
	return autoConvert_config_OpenTelemetryConfig_To_v1beta1_OpenTelemetryConfig(in, out, s)
}
